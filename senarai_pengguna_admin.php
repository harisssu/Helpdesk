            ...
            <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
                ...
                <style>
                    ...
                    #editUserModal h3 {
                        ...
                        margin-bottom: 20px;
                        font-size: 22px;
                        color: #0306a0ff; /* same as your topbar blue */
                        text-align: center;
                    }
            ...
            <body>
                ...
                <script>
                    ...
                    function closeAddModal() {
                        $('#addUserModal').hide();
                        $('#addUserForm')[0].reset(); // clear all input fields
                    }

                    // Optional: after successful submission, clear and close modal
                    ...
                    // Trigger filter instantly when dropdown changes
