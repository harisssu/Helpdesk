...
// pastikan login sebagai Ketua Unit
...
$sql = "
    SELECT 
        ...
        'Staf' AS namaPeranan
    FROM `user` u
    JOIN jabatan j ON u.idJabatan = j.idJabatan
...
<html>
<head>
    <title>Senarai Pengguna Unit</title>
    ...
    <div class="layout">
        ...
        <div class="menu">
            <a href="ketuaunitdashboard.php">Status Aduan</a>
                <a href="Hantar_Aduan_KetuaUnit.php" >Hantar Aduan</a>
        ...
        <table class="aduan-table">
            ...
            <tbody>
                ...
                if(mysqli_num_rows($result) > 0){
                    ...
                    echo "<tr><td colspan='6'>Tiada pengguna dalam unit anda</td></tr>";
                }
                ?>
            </tbody>
        </table>
